...
module.exports = "<!--The content below is only a placeholder and can be replaced.-->\n<app-topo></app-topo>\n\n<div *ngIf=\"jogoEmAndamento; else fimDeJogo\">\n    <app-painel (encerrarJogo)=\"encerrarJogo($event)\"></app-painel>\n</div>\n\n<ng-template #fimDeJogo>\n    <div *ngIf=\"tipoEncerramento === 'derrota'; else fimDeJogoVitoria\" class=\"container\" style=\"color:red;\">\n        <div class=\"row\">\n            <div class=\"col\">\n                <h1>Fim do Jogo você perdeu :S</h1>\n                <button (click)=\"reiniciarJogo()\" class=\"btn btn-primary\">Jogar Novamente</button>\n            </div>\n        </div>\n    </div>\n</ng-template>\n\n<ng-template #fimDeJogoVitoria>\n    <div class=\"container\" style=\"color:green;\">\n        <div class=\"row\">\n            <div class=\"col\">\n                <h1>Parabéns você venceu :)</h1>\n                <button (click)=\"reiniciarJogo()\" class=\"btn btn-primary\">Jogar Novamente</button>\n            </div>\n        </div>\n    </div>\n</ng-template>"
...
var FRASES = [
    ...
    { fraseEng: 'How are you?', frasePtBr: 'Como esta você?' },
...
var PainelComponent = /** @class */ (function () {
    ...
    PainelComponent.prototype.montarFrase = function () {
        this.rodadaFrase = this.frases[this.rodada];
        this.progresso += (100 / this.frases.length);
    };
    PainelComponent.prototype.atualizarResposta = function (evento) {
    ...
    PainelComponent.prototype.verificarResposta = function () {
        if (this.resposta.toLowerCase() === this.rodadaFrase.frasePtBr.toLowerCase()) {
            ...
            this.rodada++;
            var maximoDeRodadas = this.frases.length;
    ...
    PainelComponent.prototype.iniciarNovamente = function () {
        this.rodada = 0;
        this.progresso = 0;
        this.tentativas = 3;
        this.resposta = '';
...
module.exports = ".progress {\r\n    background-color: #aafbb0;\r\n    border: solid 1px #09bb16\r\n}\r\n\r\n.progress-bar {\r\n    background-color: #09bb16;\r\n}\r\n\r\n"
...
var Coracao = /** @class */ (function () {
    function Coracao(cheio, urlCoracaoCheio, urlCoracaoVazio) {
        ...
        this.msgCoracaoCheio = 'Este Coração esta Cheio';
        this.msgCoracaoVazio = 'Este Coração esta Vazio';
    }
    ...
    Coracao.prototype.mensagemCoracao = function () {
        if (this.cheio) {
...
module.exports = "<!-- \n    <img [src]=\"tipoCoracaoImg\" [alt]=\"coracaoCheio\" [title]=\"coracaoCheio\" />\n    <img [src]=\"tipoCoracaoImg\" [alt]=\"coracaoCheio\" [title]=\"coracaoCheio\" />\n    <img [src]=\"tipoCoracaoImg\" [alt]=\"coracaoVazio\" [title]=\"coracaoVazio\" />\n-->\n\n<img *ngFor=\"let coracao of coracoes\" \n    [src]=\"coracao.exibeCoracao()\" \n    [alt]=\"coracao.mensagemCoracao()\" \n    [title]=\"coracao.mensagemCoracao()\">"
...
var TentativasComponent = /** @class */ (function () {
    ...
    TentativasComponent.prototype.ngOnChanges = function () {
        this.coracoes = [new _shared_coracao_model__WEBPACK_IMPORTED_MODULE_1__["Coracao"](false), new _shared_coracao_model__WEBPACK_IMPORTED_MODULE_1__["Coracao"](false), new _shared_coracao_model__WEBPACK_IMPORTED_MODULE_1__["Coracao"](false)];
        if (this.tentativas > 0) {
            for (var count = 0; count < this.tentativas; count++) {
...
var TopoComponent = /** @class */ (function () {
    function TopoComponent() {
        this.titulo = 'Ryan Games - Learn english';
    }
...
module.exports = __webpack_require__(/*! C:\Dados\Projetos\Angular\angularapp1\src\main.ts */"./src/main.ts");
